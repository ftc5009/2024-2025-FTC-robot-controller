...
class Auto_chamber_SecondComp_v2: LinearOpMode() {
    ...
    override fun runOpMode() {
        ...
        .segment(Point(32.5, 63.0 * linearadjust, 0.0)
                ...
                ,Point(28.0, 25.0 * linearadjust, -179.0).setTolerance(4.0)
                ,Point(26.0, 25.0 * linearadjust, -179.0,"drop_arm")
        )
        .wait("picked_up")
        .segment(Point(21.0, 27.0,-90.0).setTolerance(4.0)
                ,Point(19.0, 30.0, -90.0)
        )
        .segment(Point(25.0, 63.0 * linearadjust, 0.0, "arm_up").setTolerance(4.0)
                ,Point(39.0, 73.0 * linearadjust, 0.0, "chamber_up").setTolerance(4.0)
                ,Point(37.0, 70.0 * linearadjust, 0.0))
        .wait("chamber_ready")
